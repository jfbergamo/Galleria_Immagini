...
<body>
    <div class="container text-center my-4">
        ...
        <?php if (isset($error)): ?>
        <!-- In caso di errore mostra un alert col messaggio di errore. (esempio: Accesso negato) -->
        ...
        <div class="d-inline-flex flex-column">
            <form method="POST" class="mt-3">
                <p>
                    <input class="form-control" type="text" placeholder="Nome utente" name="username" required>
                </p>
                <input class="mb-3 form-control" type="password" placeholder="Password" name="password" required>
                <p>
